...
t.exports=function(t){return function(e,i){var o,u,a=String(n(e)),s=r(i),f=a.length;return s<0||s>=f?t?"":void 0:(o=a.charCodeAt(s))<55296||o>56319||s+1===f||(u=a.charCodeAt(s+1))<56320||u>57343?t?a.charAt(s):o:t?a.slice(s,s+2):(o-55296<<10)+(u-56320)+65536}}}),l.register("ewdaw",function(t,e){var r=l("9RPct"),n=l("j7MxC"),i=l("7MjiS"),o=l("32XMx"),u=l("hzXd1"),a=l("8TKut"),s=l("7sPeB"),f=l("4pbya"),c=l("cdz0e")("iterator"),h=!([].keys&&"next"in[].keys()),p="values",d=function(){return this};t.exports=function(t,e,l,g,y,v,m){a(l,e,g);var b,w,E,x=function(t){return!h&&t in O?O[t]:function(){return new l(this,t)}},S=e+" Iterator",j=y==p,A=!1,O=t.prototype,C=O[c]||O["@@iterator"]||y&&O[y],R=C||x(y),M=y?j?x("entries"):R:void 0,N="Array"==e&&O.entries||C;if(N&&(E=f(N.call(new t)))!==Object.prototype&&E.next&&(// Set @@toStringTag to native iterators
s(E,S,!0),r||"function"==typeof E[c]||o(E,c,d)),j&&C&&C.name!==p&&(A=!0,R=function(){return C.call(this)}),(!r||m)&&(h||A||!O[c])&&o(O,c,R),// Plug for library
u[e]=R,u[S]=d,y){if(b={values:j?R:x(p),keys:v?R:x("keys"),entries:M},m)for(w in b)w in O||i(O,w,b[w]);else n(n.P+n.F*(h||A),e,b)}return b}}),l.register("hzXd1",function(t,e){t.exports={}}),l.register("8TKut",function(t,e){var r=l("bM3dy"),n=l("8d3kR"),i=l("7sPeB"),o={};// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
...
// 5 -> Array#find
// 6 -> Array#findIndex
var r=l("6GCGy"),n=l("g20Iz"),i=l("3AbA4"),o=l("1NrN9"),u=l("y9aa0");t.exports=function(t,e){var a=1==t,s=2==t,f=3==t,c=4==t,l=6==t,h=5==t||l,p=e||u;return function(e,u,d){for(var g,y,v=i(e),m=n(v),b=r(u,d,3),w=o(m.length),E=0,x=a?p(e,w):s?p(e,0):void 0;w>E;E++)if((h||E in m)&&(y=b(g=m[E],E,v),t)){if(a)x[E]=y;// map
else if(y)switch(t){case 3:return!0;// some
case 5:return g;// find
case 6:return E;// findIndex
case 2:x.push(g);// filter
}else if(c)return!1;// every
}return l?-1:f||c?c:x}}}),l.register("y9aa0",function(t,e){// 9.4.2.3 ArraySpeciesCreate(originalArray, length)
...
u("function"==typeof t?t:Function(t),e)},r(y),y},p=function(t){delete v[t]},"process"==l("kuT9T")(c)?r=function(t){c.nextTick(o(b,t,1))}:g&&g.now?r=function(t){g.now(o(b,t,1))}:d?(i=(n=new d).port2,n.port1.onmessage=w,r=o(i.postMessage,i,1)):f.addEventListener&&"function"==typeof postMessage&&!f.importScripts?(r=function(t){f.postMessage(t+"","*")},f.addEventListener("message",w,!1)):r=m in s("script")?function(t){a.appendChild(s("script"))[m]=function(){a.removeChild(this),b.call(t)}}:function(t){setTimeout(o(b,t,1),0)}),t.exports={set:h,clear:p}}),l.register("gW0wq",function(t,e){var r=l("7MjiS");t.exports=function(t,e,n){for(var i in e)r(t,i,e[i],n);return t}}),l.register("5pzc4",function(t,e){var r=l("lprt2"),n=l("j7MxC"),i=l("7MjiS"),o=l("gW0wq"),u=l("fEP1Q"),a=l("gyDPF"),s=l("9mPkg"),f=l("94XlN"),c=l("fRae5"),h=l("5zzzh"),p=l("7sPeB"),d=l("gxoWl");t.exports=function(t,e,l,g,y,v){var m=r[t],b=m,w=y?"set":"add",E=b&&b.prototype,x={},S=function(t){var e=E[t];i(E,t,"delete"==t?function(t){return(!v||!!f(t))&&e.call(this,0===t?0:t)}:"has"==t?function(t){return(!v||!!f(t))&&e.call(this,0===t?0:t)}:"get"==t?function(t){return v&&!f(t)?void 0:e.call(this,0===t?0:t)}:"add"==t?function(t){return e.call(this,0===t?0:t),this}:function(t,r){return e.call(this,0===t?0:t,r),this})};if("function"==typeof b&&(v||E.forEach&&!c(function(){new b().entries().next()}))){var j=new b,A=j[w](v?{}:-0,1)!=j,O=c(function(){j.has(1)}),C=h(function(t){new b(t)}),R=!v&&c(function(){for(// V8 ~ Chromium 42- fails only with 5+ elements
var t=new b,e=5;e--;)t[w](e,e);return!t.has(-0)});C||((b=e(function(e,r){s(e,b,t);var n=d(new m,e,b);return void 0!=r&&a(r,y,n[w],n),n})).prototype=E,E.constructor=b),(O||R)&&(S("delete"),S("has"),y&&S("get")),(R||A)&&S(w),v&&E.clear&&delete E.clear}else o(// create collection constructor
(b=g.getConstructor(e,t,y,w)).prototype,l),u.NEED=!0;return p(b,t),x[t]=b,n(n.G+n.W+n.F*(b!=m),x),v||g.setStrong(b,t,y),b}}),l.register("fEP1Q",function(t,e){var r=l("bne29")("meta"),n=l("94XlN"),i=l("cCd8e"),o=l("bYC6f").f,u=0,a=Object.isExtensible||function(){return!0},s=!l("fRae5")(function(){return a(Object.preventExtensions({}))}),f=function(t){o(t,r,{value:{i:"O"+ ++u,w:{}// weak collections IDs
...
var r=l("gn4MW");r(r.G,{global:l("750bJ")})}),l.register("gn4MW",function(t,e){var r=l("750bJ"),n=l("2sNLL"),i=l("aZ2Cd"),o=l("bddD1"),u=l("fsw4F"),a="prototype",s=function(t,e,f){var c,l,h,p=t&s.F,d=t&s.G,g=t&s.S,y=t&s.P,v=t&s.B,m=t&s.W,b=d?n:n[e]||(n[e]={}),w=b[a],E=d?r:g?r[e]:(r[e]||{})[a];for(c in d&&(f=e),f)!(// contains in native
(l=!p&&E&&void 0!==E[c])&&u(b,c))&&(// export native or passed
h=l?E[c]:f[c],// prevent global pollution for namespaces
b[c]=d&&"function"!=typeof E[c]?f[c]:v&&l?i(h,r):m&&E[c]==h?function(t){var e=function(e,r,n){if(this instanceof t){switch(arguments.length){case 0:return new t;case 1:return new t(e);case 2:return new t(e,r)}return new t(e,r,n)}return t.apply(this,arguments)};return e[a]=t[a],e;// make static versions for prototype methods
...
E(X,"Symbol"),// 20.2.1.9 Math[@@toStringTag]
E(Math,"Math",!0),// 24.3.3 JSON[@@toStringTag]
E(h.JSON,"JSON",!0);var g=l("j7MxC");// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
...
var I=l("94XlN"),v=l("fEP1Q"),tE=v.onFreeze;l("ePrDR")("freeze",function(t){return function(e){return t&&I(e)?t(tE(e)):e}});// 19.1.2.17 Object.seal(O)
var I=l("94XlN"),v=l("fEP1Q"),tx=v.onFreeze;l("ePrDR")("seal",function(t){return function(e){return t&&I(e)?t(tx(e)):e}});// 19.1.2.15 Object.preventExtensions(O)
...
var g=l("j7MxC"),eE=Math.exp;// V8 near Chromium 38 has a problem with very small numbers
g(g.S+g.F*l("fRae5")(function(){return -.00000000000000002!=!Math.sinh(-.00000000000000002)}),"Math",{sinh:function(t){return 1>Math.abs(t=+t)?(ev(t)-ev(-t))/2:(eE(t-1)-eE(-t-1))*(Math.E/2)}});// 20.2.2.33 Math.tanh(x)
var g=l("j7MxC"),ex=Math.exp;g(g.S,"Math",{tanh:function(t){var e=ev(t=+t),r=ev(-t);return e==1/0?1:r==1/0?-1:(e-r)/(ex(t)+ex(-t))}});// 20.2.2.34 Math.trunc(x)
...
for(var g,y=String((l=c[d])[0]),v=rT(rB(t6(l.index),u.length),0),m=[],b=1;b<l.length;b++)m.push(void 0===(g=l[b])?g:String(g));var w=l.groups;if(a){var E=[y].concat(m,v,u);void 0!==w&&E.push(w);var x=String(e.apply(void 0,E))}else x=// https://tc39.github.io/ecma262/#sec-getsubstitution
function(t,e,n,i,o,u){var a=n+t.length,s=i.length,f=rk;return void 0!==o&&(o=P(o),f=rL),r.call(u,f,function(r,u){var f;switch(u.charAt(0)){case"$":return"$";case"&":return t;case"`":return e.slice(0,n);case"'":return e.slice(a);case"<":f=o[u.slice(1,-1)];break;default:var c=+u;if(0===c)return r;if(c>s){var l=rF(c/10);if(0===l)return r;if(l<=s)return void 0===i[l-1]?u.charAt(1):i[l-1]+u.charAt(1);return r}f=i[c-1]}return void 0===f?"":f})}(y,u,v,m,w,e);v>=p&&(h+=u.slice(p,v)+x,p=v+y.length)}return h+u.slice(p)}]});var _=l("lIYjb"),rU=l("fEHMJ");// @@search logic
...
race:function(t){var e=this,r=nn(e),n=r.reject,i=r1(function(){rK(t,!1,function(t){e.resolve(t).then(r.resolve,n)})});return i.e&&n(i.v),r.promise}});var nh={},z=l("bYC6f"),np=z.f,k=l("bM3dy"),nd=l("gW0wq"),eH=l("6GCGy"),rH=l("9mPkg"),rK=l("gyDPF"),ng=l("ewdaw"),ny=l("gVJWk"),nv=l("8LMaW"),d=l("lE182"),v=l("fEP1Q"),nm=v.fastKey,nb={},I=l("94XlN");nb=function(t,e){if(!I(t)||t._t!==e)throw TypeError("Incompatible receiver, "+e+" required!");return t};var nw=d?"_s":"size",nE=function(t,e){// fast case
...
set:function(t,e){return nj.def(nb(this,nT),t,e)}},nD=l("5pzc4")(nT,nk,nU,nj,!0,!0);nb&&nP&&(nS((iR=nj.getConstructor(nk,nT)).prototype,nU),v.NEED=!0,nx(["delete","has","get","set"],function(t){var e=nD.prototype,r=e[t];y(e,t,function(e,n){// store frozen objects on internal weakmap shim
...
var b={};f(b,u,function(){return this});var w=Object.getPrototypeOf,E=w&&w(w(R([])));E&&E!==r&&n.call(E,u)&&// of the polyfill.
(b=E);var x=m.prototype=y.prototype=Object.create(b);// Helper for defining the .next, .throw, and .return methods of the
...
return v.prototype=m,i(x,"constructor",{value:m,configurable:!0}),i(m,"constructor",{value:v,configurable:!0}),v.displayName=f(m,s,"GeneratorFunction"),t.isGeneratorFunction=function(t){var e="function"==typeof t&&t.constructor;return!!e&&(e===v||"GeneratorFunction"===// For the native GeneratorFunction constructor, the best we can
// do is to check its .name property.
(e.displayName||e.name))},t.mark=function(t){return Object.setPrototypeOf?Object.setPrototypeOf(t,m):(t.__proto__=m,f(t,s,"GeneratorFunction")),t.prototype=Object.create(x),t},// Within the body of any async function, `await x` is transformed to
...
S(x),f(x,s,"Generator"),// A Generator should always return itself as the iterator object when the
// @@iterator function is called on it. Some browsers' implementations of the
// iterator prototype chain incorrectly implement this, causing the Generator
// object to not be returned from this call. This ensures that doesn't happen.
// See https://github.com/facebook/regenerator/issues/274 for more details.
f(x,u,function(){return this}),f(x,"toString",function(){return"[object Generator]"}),t.keys=function(t){var e=Object(t),r=[];for(var n in e)r.push(n);// Rather than returning an object with a next method, we keep
...
(n=n.slice(0,i)),n}(t,e);if(ArrayBuffer.isView(t))return function(t){if(oW(t,Uint8Array)){let e=new Uint8Array(t);return oE(e.buffer,e.byteOffset,e.byteLength)}return ow(t)}(t);if(null==t)throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof t);if(oW(t,ArrayBuffer)||t&&oW(t.buffer,ArrayBuffer)||"undefined"!=typeof SharedArrayBuffer&&(oW(t,SharedArrayBuffer)||t&&oW(t.buffer,SharedArrayBuffer)))return oE(t,e,r);if("number"==typeof t)throw TypeError('The "value" argument must not be of type number. Received type number');let n=t.valueOf&&t.valueOf();if(null!=n&&n!==t)return oy.from(n,e,r);let i=function(t){var e;if(oy.isBuffer(t)){let e=0|ox(t.length),r=og(e);return 0===r.length||t.copy(r,0,0,e),r}return void 0!==t.length?"number"!=typeof t.length||(e=t.length)!=e// eslint-disable-line no-self-compare
?og(0):ow(t):"Buffer"===t.type&&Array.isArray(t.data)?ow(t.data):void 0}(t);if(i)return i;if("undefined"!=typeof Symbol&&null!=Symbol.toPrimitive&&"function"==typeof t[Symbol.toPrimitive])return oy.from(t[Symbol.toPrimitive]("string"),e,r);throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof t)}function om(t){if("number"!=typeof t)throw TypeError('"size" argument must be of type number');if(t<0)throw RangeError('The value "'+t+'" is invalid for option "size"')}function ob(t){return om(t),og(t<0?0:0|ox(t))}function ow(t){let e=t.length<0?0:0|ox(t.length),r=og(e);for(let n=0;n<e;n+=1)r[n]=255&t[n];return r}function oE(t,e,r){let n;if(e<0||t.byteLength<e)throw RangeError('"offset" is outside of buffer bounds');if(t.byteLength<e+(r||0))throw RangeError('"length" is outside of buffer bounds');return(// Return an augmented `Uint8Array` instance
Object.setPrototypeOf(n=void 0===e&&void 0===r?new Uint8Array(t):void 0===r?new Uint8Array(t,e):new Uint8Array(t,e,r),oy.prototype),n)}function ox(t){// Note: cannot use `length < K_MAX_LENGTH` here because that fails when
 ...
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),i=Array(t),o=0,u=0;return e=void 0!==e?e:1e3,function(a){let s=Date.now(),f=i[u];r||(r=s),n[o]=a,i[o]=s;let c=u,l=0;for(;c!==o;)l+=n[c++],c%=t;if((o=(o+1)%t)===u&&(u=(u+1)%t),s-r<e)return;let h=f&&s-f;return h?Math.round(1e3*l/h):void 0}};function uE(t,e){let r=0,n=uw(50,250);return i=>{let o=i.loaded,u=i.lengthComputable?i.total:void 0,a=o-r,s=n(a),f=o<=u;r=o;let c={loaded:o,total:u,progress:u?o/u:void 0,bytes:a,rate:s||void 0,estimated:s&&u&&f?(u-o)/s:void 0,event:i};c[e?"download":"upload"]=!0,t(c)}}let ux="undefined"!=typeof XMLHttpRequest;var uS=ux&&function(t){return new Promise(function(e,r){let n,i=t.data,o=up.from(t.headers).normalize(),u=t.responseType;function a(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}oi.isFormData(i)&&(un.isStandardBrowserEnv||un.isStandardBrowserWebWorkerEnv?o.setContentType(!1):o.setContentType("multipart/form-data;",!1));let s=new XMLHttpRequest;// HTTP basic authentication
...
void 0===i&&o.setContentType(null),"setRequestHeader"in s&&oi.forEach(o.toJSON(),function(t,e){s.setRequestHeader(e,t)}),oi.isUndefined(t.withCredentials)||(s.withCredentials=!!t.withCredentials),u&&"json"!==u&&(s.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&s.addEventListener("progress",uE(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&s.upload&&s.upload.addEventListener("progress",uE(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
...
let{Axios:uU,AxiosError:uD,CanceledError:uz,isCancel:uY,CancelToken:uG,VERSION:uq,all:uX,Cancel:uW,isAxiosError:uV,spread:uJ,toFormData:uH,AxiosHeaders:uK,HttpStatusCode:u$,formToJSON:uQ,getAdapter:uZ,mergeConfig:u0}=uk,u1=()=>{let t=document.querySelector(".alert");t&&t.parentElement.removeChild(t)},u2=(t,e,r=3)=>{u1();let n=`<div class="alert alert--${t}">${e}</div>`;document.querySelector("body").insertAdjacentHTML("afterbegin",n),window.setTimeout(u1,1e3*r)},u5=async(t,e,r,n)=>{try{let i=await uk({method:"POST",url:"/api/v1/users/sign-up",data:{name:t,email:e,password:r,passwordConfirmation:n}});"success"===i.data.status&&(u2("success","Sign up successfully! Please check email from us \uD83D\uDE0A"),window.setTimeout(()=>{location.assign("/")},1500))}catch(t){u2("error",t.response.data.message)}},u6=async(t,e)=>{try{let r=await uk({method:"POST",url:"/api/v1/users/login",data:{email:t,password:e}});"success"===r.data.status&&(u2("success","Logged in successfully!"),window.setTimeout(()=>{location.assign("/")},1500))}catch(t){u2("error",t.response.data.message)}},u4=async()=>{try{let t=await uk({method:"GET",url:"/api/v1/users/logout"});"success"===t.data.status&&(location.reload(!0),location.assign("/login"))}catch(t){u2("error","Error logging out! Try again.")}},u7=async t=>{try{let e=await uk({method:"PATCH",url:"/api/v1/users/update-me",data:t});"success"===e.data.status&&u2("success","Data updated successfully!")}catch(t){u2("error",t.response.data.message)}},u8=async(t,e,r)=>{try{let n=await uk({method:"PATCH",url:"/api/v1/users/update-password",data:{currentPassword:t,password:e,passwordConfirmation:r}});"success"===n.data.status&&u2("success","Password updated successfully!")}catch(t){u2("error",t.response.data.message)}},u3=async(t,e)=>{let r=Stripe("pk_test_51Non8ZFMCUqSDWAFwUkxz9gKOD2dsMQQPWYmIUzmhtT77FCUiRRzhoi5fUinz0t5NXB8ixNPQDOGpBKj031WtP8F00CVYhEMNM");try{// 1. Get checkout session from API
let n=await uk(`/api/v1/bookings/checkout-session/${t}/${e}`);// 2. Create checkout form + charge credit card
await r.redirectToCheckout({sessionId:n.data.session.id})}catch(t){u2("error",t.response.data.message)}},u9=async(t,e,r)=>{try{let n=await uk({method:"POST",url:`/api/v1/tours/${r}/reviews`,data:{review:t,rating:e}});"success"===n.data.status&&(u2("success","Review has been successfully added."),window.setTimeout(()=>{location.reload(!0)},1500))}catch(t){u2("error",t.response.data.message)}},at=document.getElementById("map"),ae=document.querySelector(".form--signUp"),ar=document.querySelector(".form--login"),an=document.querySelector(".nav__el--logout"),ai=document.querySelector(".form-user-data"),ao=document.querySelector(".form-user-password"),au=document.querySelector(".form__user-photo"),aa=document.querySelector("#photo"),as=document.getElementById("book-tour"),af=document.querySelector(".selectStartDate"),ac=document.querySelector(".form-leave-review");// DELEGATION
if(at){let t=JSON.parse(document.getElementById("map").dataset.locations);(t=>{var e=L.map("map",{zoomControl:!1});L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(e);let r=[];t.forEach(t=>{r.push([t.coordinates[1],t.coordinates[0]]),L.marker([t.coordinates[1],t.coordinates[0]]).addTo(e).bindPopup(`<p>Day ${t.day}: ${t.description}</p>`,{autoClose:!1}).openPopup()});let n=L.latLngBounds(r).pad(.5);e.fitBounds(n),e.scrollWheelZoom.disable()})(t)}ae&&ae.addEventListener("submit",async t=>{t.preventDefault(),document.querySelector(".btn--signUp").textContent="Processing...",document.querySelector(".btn--signUp").setAttribute("disabled",!0),document.querySelector(".btn--signUp").cursor="not-allowed";let e=document.getElementById("name").value,r=document.getElementById("email").value,n=document.getElementById("password").value,i=document.getElementById("passwordConfirmation").value;await u5(e,r,n,i),document.querySelector(".btn--signUp").textContent="Sign up",document.querySelector(".btn--signUp").removeAttribute("disabled"),document.querySelector(".btn--signUp").removeAttribute("style")}),ar&&ar.addEventListener("submit",t=>{t.preventDefault();let e=document.getElementById("email").value,r=document.getElementById("password").value;u6(e,r)}),an&&an.addEventListener("click",u4),ai&&(((t,e)=>{e.addEventListener("change",e=>{let r=e.target.files?.[0];if(!r?.type.startsWith("image/"))return;let n=new FileReader;n.addEventListener("load",()=>{t.setAttribute("src",n.result)}),n.readAsDataURL(r)})})(au,aa),ai.addEventListener("submit",t=>{t.preventDefault();let e=new FormData;e.append("name",document.getElementById("name").value),e.append("email",document.getElementById("email").value),e.append("photo",document.getElementById("photo").files[0]),u7(e)})),ao&&ao.addEventListener("submit",async t=>{t.preventDefault();let e=document.querySelector(".btn--save-password");e.textContent="Updating...",e.setAttribute("disabled",!0),e.style.cursor="not-allowed";let r=document.getElementById("password-current").value,n=document.getElementById("password").value,i=document.getElementById("password-confirm").value;await u8(r,n,i),e.textContent="Save password",e.removeAttribute("disabled"),e.removeAttribute("style"),document.getElementById("password-current").value="",document.getElementById("password").value="",document.getElementById("password-confirm").value=""}),as&&as.addEventListener("click",async t=>{t.target.textContent="Processing...",t.target.setAttribute("disabled",!0),t.target.style.cursor="not-allowed";let{tourId:e}=t.target.dataset,r=af.value;await u3(e,r),t.target.textContent="Book tour now!",t.target.removeAttribute("disabled"),t.target.removeAttribute("style")});let al=document.querySelector("body").dataset.alert;if(al){u2("success",al,10);let t=window.location.href,e=new URL(t);e.search="",window.setTimeout(()=>{location.assign(e.toString())},10500)}ac&&ac.addEventListener("submit",t=>{t.preventDefault();let e=document.getElementById("review").value,r=document.getElementById("rating").value,n=ac.dataset.tourId;u9(e,r,n)})}();